...
performance improves by 58\% with a 2MB LLC while performance improves
by 78\% with a 32MB LLC. This can be explained by the fact that larger
LLCs accommodate more translation entries to be cached in the UCAT
structure.
