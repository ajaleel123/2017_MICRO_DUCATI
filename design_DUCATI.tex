...
system.\ee{I don't remember ever discussing the perfect last level TLB 
before, we might want to describe what that means here in one sentence if 
this is indeed the first time we talk about it.} To provide insight into
...
80\%\ee{I don't see how 1.81x and 2.24x leads to 80\% of the performance gap being covered, it seems more like 64\% or something like that to me} of the performance gap between the baseline system and an
...
\ee{What's concerning to me here is that we haven't other than one or a few sentences in the intro spoken about why using 2MB pages isn't good enough that this is a problem worth addressing. I might be spacing out, but if we haven't we probably want to emphasize this somehow maybe here?}
\begin{figure}[tp] 
\vspace{0. in} \centering
