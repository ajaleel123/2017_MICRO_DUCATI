...
% % Figure~\ref{fig:hitrate_stackedTLB} illustrates the performance
...
% Figure~\ref{fig:hitrate_stackedTLB} illustrates the required
...
\boldheadingpara{Storage Space} The in-memory storage overhead for
