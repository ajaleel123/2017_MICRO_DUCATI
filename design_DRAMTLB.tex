...
the missing virtual address. The set index $SI$ is then used to
...
MMU), associativity $A$, and TLB-entry size $s$ (16 bytes in our
case), the physical address for the DRAM-TLB entry is computed using
combinational logic:
