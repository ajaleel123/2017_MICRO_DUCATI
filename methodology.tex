...
\noindent Our workloads consist of a subset of CUDA-based high
performance computing applications from the CORAL~\cite{CORAL},
...
program regions and warm up the caches, TLBs, and PWCs by executing
four billion warp instructions. After functional warmup, we enable
detailed timing simulation for two billion warp instructions.
