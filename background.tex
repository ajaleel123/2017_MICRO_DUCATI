...
In Figure~\ref{fig:tlb_sensitivity} we already motivated increasing TLB
coverage by demonstrating its direct impact on performance. Table~\ref{table:bench_char} 
