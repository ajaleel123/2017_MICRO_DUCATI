...
\boldheadingpara{Inverted Page Tables} \ee{This section is pretty
...
in order.} DRAM-TLBs leverage the hierarchical page table structure
...
other hand, DRAM-TLBs provide address translation using a single
