...
% EIMAN-03-21: last sentence can be better tied to previous sentences.
...
%EIMAN-03-21: leaving this for now but we can probably do better in the 
%second paragraph of intro. Most of above probably belongs in the 
%background section. The paragraph below seems like a better follow-on
%to the first paragraph. I guess you just want to have mentioned LLT
% and somehow ended up with the long background-esque paragraph above.
...
%EIMAN-03-21: did someone explicitly in the past take issue with why
%direct segments was not highlighted in the paper? If not, this looks
%like it should be in related work to me. Not here.
...
%EIMAN-03-21: The above paragraph can be pulled up to be the third paragraph
%maybe and then the material in it can be used to frame the two problems
%of frequency of LLT misses and latency of said misses that this work is
%trying to address.
