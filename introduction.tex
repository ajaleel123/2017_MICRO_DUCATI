...
This paper proposes two hardware mechanisms to improve LLT coverage
...
\begin{enumerate}
  ...
  \item{We reduce LLC miss penalty by architecting {\em TLBs in DRAM
    ...
    coverage by only occupying a very small portion of gigantic DRAM sizes in today's systems. Unlike a page table walk, a DRAM-TLB provides
