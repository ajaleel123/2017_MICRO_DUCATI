...
performance by 10\% with 2MB page size.
...
81\% (up to 4.5x). All proposals require negligible changes to the
baseline system. Finally, we show that DUCATI improves performance by
81\%, 56\%, and 8\% when using 4KB, 64KB, and 2MB pages respectively.
